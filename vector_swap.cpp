...
void vector_swap(vector<int>& v1, vector<int>& v2, int start1, int end1, int start2, int end2) {
    vector<int> c1(v1.begin()+start1, v1.begin()+end1);
    vector<int> c2(v2.begin()+start2, v2.begin()+end2);
    v1.erase(v1.begin()+start1, v1.begin()+end1);
    v2.erase(v2.begin()+start2, v2.begin()+end2);
    v1.insert(v1.begin()+start1, c2.begin(), c2.end());
    v2.insert(v2.begin()+start2, c1.begin(), c1.end());
}
